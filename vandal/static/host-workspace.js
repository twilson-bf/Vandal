...
renderers.explore=async function(token){
 ...
 <details class="search-help"><summary>Search syntax</summary><p>Search current evidence. Examples: <code>hostname:example.com port:443 has:vuln scope_tag:"EPT inventory" coverage:scanned</code>. Previous observations are under each host's History.</p></details>
